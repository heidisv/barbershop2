...
public class Statistics
{
	...
	public void printReport(long simulationLength) {
		...
		System.out.println("Average throughput (process per second):                      "+(float) nofCompletedProcesses / simulationLength *1000);
		...
		if(nofCompletedProcesses > 0) {
			...
			System.out.println("Average time spent prossesing per process:					  "+
